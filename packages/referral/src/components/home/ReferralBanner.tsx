...
// import { useInviteBasics, useInviteInfo, useInviteChannel } from '@/api/hook';
// import assets from '@/assets';

// import * as referralCreate from './ReferralCreate';
// import './ReferralBanner.less';
...
//                     <dd>
//                     <Trans t={t} i18nKey="login_desc" values={{ lutPrize: `<strong>${lutPrize} LUT</strong>`, rebateLimit: `<strong>${rebateLimit} USDT</strong>` }} />
//                     </dd>
//                 </dl>
...
//                         <dl>
//                             <dt>{t('share_title')}</dt>
//                             <dd><span onClick={handleCreate}>{t('btn_create_new')} +</span></dd>
//                         </dl>
//                         <ul>
//                             <li>
